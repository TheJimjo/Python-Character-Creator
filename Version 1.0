...
class Character_DnD:
    ...
    def is_dead(self):
        ...
        if self.hit_points <= 0:
            print("{name} is at zero hit points and is dead.".format(name=self.name.title))

    def stat_increase(self):
        character_attribute_points = 26
        while character_attribute_points > 0:
            print(f"You currently have {character_attribute_points} points available to spend.")
            ...
            if character_attribute_build.lower() == "strength":
                if self.strength > 14:
                    ...
                    print(f"Your strength is now {self.strength}. You have {character_attribute_points} remaining.")
                continue
            if character_attribute_build.lower() == "dexterity":
                if self.dexterity > 14:
                    ...
                    if 8 <= self.dexterity <= 13:
                        ...
                        character_attribute_points -= 2
                    print(f"Your dexterity is now {self.dexterity}. You have {character_attribute_points} remaining.")
                continue
            if character_attribute_build.lower() == "constitution":
                if self.constitution > 14:
                    ...
                    if 8 <= self.constitution <= 13:
                        ...
                        character_attribute_points -= 2
                    print(f"Your constitution is now {self.constitution}. You have {character_attribute_points} remaining.")
                continue
            if character_attribute_build.lower() == "intelligence":
                if self.intelligence > 14:
                    ...
                    if 8 <= self.intelligence <= 13:
                        ...
                        character_attribute_points -= 2
                    print(f"Your intelligence is now {self.intelligence}. You have {character_attribute_points} remaining.")
                continue
            if character_attribute_build.lower() == "wisdom":
                if self.wisdom > 14:
                    ...
                    if 8 <= self.wisdom <= 13:
                        ...
                        character_attribute_points -= 2
                    print(f"Your wisdom is now {self.wisdom}. You have {character_attribute_points} remaining.")
                continue
            if character_attribute_build.lower() == "charisma":
                if self.charisma > 14:
                    ...
                    if 8 <= self.charisma <= 13:
                        ...
                        character_attribute_points -= 2
                    print(f"Your charisma is now {self.charisma}. You have {character_attribute_points} remaining.")
                continue
...
character_name = input("Please type what you would like your character name to be? ")
